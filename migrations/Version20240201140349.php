 ...
 */
final class Version20240201140349 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `procedure` ADD index_slot INT NOT NULL, ADD content LONGTEXT NOT NULL, ADD created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', ADD agent VARCHAR(255) NOT NULL, ADD image VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `procedure` DROP index_slot, DROP content, DROP created_at, DROP agent, DROP image');
    }
}
