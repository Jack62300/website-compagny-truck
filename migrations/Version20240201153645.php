 ...
 */
final class Version20240201153645 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product ADD title VARCHAR(255) NOT NULL, ADD created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', ADD agent VARCHAR(255) NOT NULL, ADD content LONGTEXT NOT NULL, ADD identifiant INT NOT NULL, ADD notice LONGTEXT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product DROP title, DROP created_at, DROP agent, DROP content, DROP identifiant, DROP notice');
    }
}
