 ...
 */
final class Version20240211100712 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE product_product_categorie (product_id INT NOT NULL, product_categorie_id INT NOT NULL, INDEX IDX_935852EA4584665A (product_id), INDEX IDX_935852EA3151C546 (product_categorie_id), PRIMARY KEY(product_id, product_categorie_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE product_product_categorie ADD CONSTRAINT FK_935852EA4584665A FOREIGN KEY (product_id) REFERENCES product (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE product_product_categorie ADD CONSTRAINT FK_935852EA3151C546 FOREIGN KEY (product_categorie_id) REFERENCES product_categorie (id) ON DELETE CASCADE');
        ...
        $this->addSql('DROP INDEX UNIQ_D34A04ADBCF5E72D ON product');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product_product_categorie DROP FOREIGN KEY FK_935852EA4584665A');
        $this->addSql('ALTER TABLE product_product_categorie DROP FOREIGN KEY FK_935852EA3151C546');
        $this->addSql('DROP TABLE product_product_categorie');
        $this->addSql('ALTER TABLE product ADD categorie_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE product ADD CONSTRAINT FK_D34A04ADBCF5E72D FOREIGN KEY (categorie_id) REFERENCES product_categorie (id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_D34A04ADBCF5E72D ON product (categorie_id)');
    }
}
