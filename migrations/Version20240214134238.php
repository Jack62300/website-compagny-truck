 ...
 */
final class Version20240214134238 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product DROP identifiant');
        $this->addSql('ALTER TABLE product_categorie DROP index_number');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product ADD identifiant INT NOT NULL');
        $this->addSql('ALTER TABLE product_categorie ADD index_number INT NOT NULL');
    }
}
