 ...
 */
final class Version20240218101628 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE registre DROP type');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE registre ADD type VARCHAR(255) NOT NULL');
    }
}
