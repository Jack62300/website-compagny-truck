 ...
 */
final class Version20240317152212 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE incident CHANGE prise_en_charge_par prise_en_charge_par VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE incident CHANGE prise_en_charge_par prise_en_charge_par VARCHAR(255) NOT NULL');
    }
}
